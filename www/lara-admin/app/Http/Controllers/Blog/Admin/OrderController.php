...
class OrderController extends AdminBaseController
{
    ...
    public function __construct()
    {
        ...
        //получения сущности контейнера * с помощью вызова хелпера app():
    }
    ...
    {
        $perpage = 5;
        $number_of_rders_in_pagination = 10;
            $countOrders = MainRepository::getCountOrders();
            $paginator = $this->orderRepository->getAllOrders($number_of_rders_in_pagination);
    ...
    {
        //Http/Request/AdminOrderSaveRequest $request -валидация 
