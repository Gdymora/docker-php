...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/adminlte/bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
     ...
     <link rel="stylesheet" href="{{asset('public/adminlte/bower_components/select2/dist/css/select2.css')}}">
     <!-- Font Awesome -->
    <!-- Font Awesome -->
...
<script src="{{asset('public/adminlte/bower_components/ckeditor/adapters/jquery.js')}}"></script>
<!-- Для select связанные товары в админке добавить товар -->
<script src="{{asset('public/adminlte/bower_components/select2/dist/js/select2.full.js')}}"></script>
