<div class="box box-danger box-solid">
    ...
    <div class="box-body" id="image" style=" border: 1px solid whitesmoke ; text-align: center; position: relative" >
        @if ($product->img == null)
            <img width="50%" height="50%" src='{{asset("public/images/no_image.jpg")}}' id="preview_image"/>
        @else
            <img width="50%" height="50%" src='{{asset("public/uploads/single/$product->img")}}' id="preview_image"/>
        @endif
